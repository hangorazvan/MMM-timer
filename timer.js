	...
	start: function() {
		...
		setInterval(function() {
			...
			if (self.config.SharpMode) {
				if ((now == "23:00:00") || (now == "00:00:00") || (now == "01:00:00")) { self.sendNotification("SHOW_ALERT", {
				...
				} else if ((now == "02:00:00") || (now == "03:00:00") || (now == "04:00:00")) { self.sendNotification("SHOW_ALERT", {
						type: "notification", title: "<i class=\"far fa-bell lime\"></i> " + self.translate("Sharp hour!"),
					...
					(now == "09:00:00") || (now == "10:00:00") || (now == "11:00:00")) { self.sendNotification("SHOW_ALERT", {
						type: "notification", title: "<i class=\"far fa-bell lime\"></i> " + self.translate("Sharp hour!"),
						message: self.translate("Time it was ") + moment().format("H:mm") + "<br>" + self.translate("Good morning!")
					});
				} else if ((now == "12:00:00") || (now == "13:00:00") || (now == "14:00:00")) { self.sendNotification("SHOW_ALERT", {
						type: "notification", title: "<i class=\"far fa-bell lime\"></i> " + self.translate("Sharp hour!"),
						message: self.translate("Time it was ") + moment().format("H:mm") + "<br>" + self.translate("Bon appetit!")
					});
				} else if ((now == "15:00:00") || (now == "16:00:00") || (now == "17:00:00")) { self.sendNotification("SHOW_ALERT", {
						type: "notification", title: "<i class=\"far fa-bell lime\"></i> " + self.translate("Sharp hour!"),
						message: self.translate("Time it was ") + moment().format("H:mm") + "<br>" + self.translate("Have a nice day!")
					});
				} else if ((now == "18:00:00") || (now == "19:00:00") || (now == "20:00:00") || 
					(now == "21:00:00") || (now == "22:00:00")) { self.sendNotification("SHOW_ALERT", {
						type: "notification", title: "<i class=\"far fa-bell lime\"></i> " + self.translate("Sharp hour!"),
