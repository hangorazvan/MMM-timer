...
*/
			if (hide == "59") {
				dqs8.forEach(function(element) {element.style.display = "none";});
			}
			...
			if (self.config.Burning) {
			    if (hide == "00") {
				    body.forEach(function(element) {return element.style["margin-right"] = "0px", element.style["margin-top"] = "1px";});
			    }
			    if (hide == "15") {
				    body.forEach(function(element) {return element.style["margin-top"] = "0px", element.style["margin-left"] = "1px";});
			    }
			    if (hide == "30") {
				    body.forEach(function(element) {return element.style["margin-left"] = "0px", element.style["margin-top"] = "-1px";});
			    }
			    if (hide == "45") {
				    body.forEach(function(element) {return element.style["margin-top"] = "0px", element.style["margin-right"] = "1px";});
			    }
			}
