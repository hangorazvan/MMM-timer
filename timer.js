...
Module.register("timer", {
	...
	start: function() {
		...
		setInterval(function() {
			...
			var fsb = document.querySelectorAll(".fullscreen.below");
			var fsba = Array.from(fsb);
			...
			if (self.config.DimMode) {
				if (self.config.FadeMode) {
					if (now >= self.config.FirstPoint + "00:00" && now < self.config.FirstPoint + ":09:59") {
						body.style.opacity = "0.93"; body.style["-webkit-filter"] = "grayscale(7.15%)";	fsb.style.opacity = "0.24";
					} else if (now >= self.config.FirstPoint + ":10:00" && now < self.config.FirstPoint + ":19:59") {
						body.style.opacity = "0.86"; body.style["-webkit-filter"] = "grayscale(14.29%)"; fsb.style.opacity = "0.2";
					} else if (now >= self.config.FirstPoint + ":20:00" && now < self.config.FirstPoint + ":29:59") {
						body.style.opacity = "0.79"; body.style["-webkit-filter"] = "grayscale(21.42%)"; fsb.style.opacity = "0.16";
					} else if (now >= self.config.FirstPoint + ":30:00" && now < self.config.FirstPoint + ":39:59") {
						body.style.opacity = "0.71"; body.style["-webkit-filter"] = "grayscale(28.57%)"; fsb.style.opacity = "0.12";
					} else if (now >= self.config.FirstPoint + ":40:00" && now < self.config.FirstPoint + ":49:59") {
						body.style.opacity = "0.64"; body.style["-webkit-filter"] = "grayscale(35.71%)"; fsb.style.opacity = "0.08";
					} else if (now >= self.config.FirstPoint + ":50:00" && now < self.config.FirstPoint + ":59:59") {
						body.style.opacity = "0.57"; body.style["-webkit-filter"] = "grayscale(42.85%)"; fsb.style.opacity = "0.04";
					} else if (now >= self.config.SecondPoint + ":00:00" && now < self.config.ThirdPoint + ":00:00") {
						body.style.opacity = "0.50"; body.style["-webkit-filter"] = "grayscale(50%)"; fsb.style.opacity = "0";
						...
						body.style.opacity = "1"; body.style["-webkit-filter"] = "grayscale(0%)"; // fsb.style.opacity = "0.3";
					}
				} else {
					if (now >= self.config.SecondPoint + ":00:00" && now < self.config.ThirdPoint + ":00:00") {
						body.style.opacity = "0.50"; body.style["-webkit-filter"] = "grayscale(50%)"; fsb.style.opacity = "0";
